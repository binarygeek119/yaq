...
<style>
#yaq-version-tag{position:fixed;right:1rem;bottom:.75rem;z-index:9999;margin:0;padding:.35rem .7rem;border-radius:999px;background:rgba(7,16,24,.88);border:1px solid rgba(255,255,255,.14);color:#c5d4de;font:500 .8rem/1 "Red Hat Display",system-ui,sans-serif;letter-spacing:.04em;pointer-events:none}
</style>
<script>
(function(){
